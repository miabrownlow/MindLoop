...
## Project Status
  ...
  The user can't change to a different colour on the colours that pulse until it has finished pulsing; change so Button B will always change the colour if the project is on.
